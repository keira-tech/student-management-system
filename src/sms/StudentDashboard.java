...
public class StudentDashboard extends javax.swing.JFrame {
     ...
     */
     private int studentId;      // store logged-in student's ID
    private String username;
     public StudentDashboard(int studentId, String username) {
        initComponents();   // initialize GUI components
        this.studentId = studentId;  // store logged-in student's ID
        this.username = username;    // store username if needed
        welcome.setText("Welcome, " + username); // optional label on dashboard
    }
...
public void setWelcome(String username){
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      viewcourse courseForm = new viewcourse(studentId);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
         viewgrade gradeForm = new viewgrade(studentId);
